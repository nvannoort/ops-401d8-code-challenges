...
def main():
    ...
    elif mode in [5, 6]:  # If the user selected a folder operation
        folder_path = input("Enter the path of the folder: ")  # Ask the user for the folder path

        if mode == 5:  # If the user selected folder encryption
            encrypt_folder(folder_path, key)  # Encrypt the folder
            print(f"Folder at {folder_path} has been encrypted successfully.")  # Notify the user of success
        elif mode == 6:  # If the user selected folder decryption
            decrypt_folder(folder_path, key)  # Decrypt the folder
            print(f"Folder at {folder_path} has been decrypted successfully.")  # Notify the user of success
